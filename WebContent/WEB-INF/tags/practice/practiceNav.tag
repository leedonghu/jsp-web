...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="<%=request.getContextPath() %>/practice01/mainPage.jsp"">메인</a>
  ...
  <div class="col-8">
    <ul class="navbar-nav mr-auto my-2 my-lg-0 navbar-nav-scroll" style="max-height: 100px;">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<%=request.getContextPath() %>/practice01/friendPage.jsp" tabindex="-1" aria-disabled="true">친구찾기</a>
      </li>
      <li class="nav-item">
